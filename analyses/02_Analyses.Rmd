...
```{r, echo = FALSE}
r <- raster::raster("../outputs/Cartographie_CaCO3.tif")
raster::plot(r, main = "CaCO3 (%)", cex.main = 1.5)
...
```{r, echo = FALSE}
r <- raster::raster("../outputs/Cartographie_LOI_550.tif")
raster::plot(r, main = "LOI 550", cex.main = 1.5)
...
```{r, echo = FALSE}
r <- raster::raster("../outputs/Cartographie_pc_clay.tif")
raster::plot(r, main = "Argiles (%)", cex.main = 1.5)
...
```{r, echo = FALSE}
r <- raster::raster("../outputs/Cartographie_pc_silt.tif")
raster::plot(r, main = "Limons (%)", cex.main = 1.5)
...
```{r, echo = FALSE}
r <- raster::raster("../outputs/Cartographie_pc_sand.tif")
raster::plot(r, main = "Sables (%)", cex.main = 1.5)
...
```{r, echo = FALSE}
r <- raster::raster("../outputs/Cartographie_pc_gravel.tif")
raster::plot(r, main = "Graviers (%)", cex.main = 1.5)
