...
# Lecture des données
data <- read.table("../data/derived-data/Donnees_sediments_2022.csv", sep = ";", dec = ".", header = TRUE, stringsAsFactors = FALSE)
...
```{r, include = FALSE}
# export_jpeg(map = map_depth, chemin = "../figures", nomFichier = "Carte_Profondeur.jpg") 
# export_jpeg(map = map_CaCO3, chemin = "../figures", nomFichier = "Carte_CaCO3.jpg")
# export_jpeg(map = map_LOI_550, chemin = "../figures", nomFichier = "Carte_LOI_550.jpg")
# export_jpeg(map = map_median, chemin = "../figures", nomFichier = "Carte_median.jpg")
# export_jpeg(map = map_clay, chemin = "../figures", nomFichier = "Carte_clay.jpg")
# export_jpeg(map = map_silt, chemin = "../figures", nomFichier = "Carte_silt.jpg")
# export_jpeg(map = map_sand, chemin = "../figures", nomFichier = "Carte_sand.jpg")
# export_jpeg(map = map_gravel, chemin = "../figures", nomFichier = "Carte_gravel.jpg")
# export_jpeg(map = map_classe, chemin = "../figures", nomFichier = "Carte_classe.jpg")
# export_jpeg(map = map_RHO, chemin = "../figures", nomFichier = "Carte_rhodolithes.jpg")

write.table(data, "../outputs/Donnees_classes_sediments_2022.csv", sep = ";", dec = ".", row.names = FALSE)
